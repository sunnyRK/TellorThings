...
const Trade = ({
  ...
  tradePairTokens, tagOptionsForETh, 
  ...
  >
    <div className="card trade">
      <h3>Automate Trade For (Swap Exact ETH For Tokens)</h3>
      ...
      <div className="form-field trade-footer">
        ...
        <Button
          ...
          bsStyle="primary"
          type="submit"
          onClick={(event) => swapExactETHForTokens(event)}
