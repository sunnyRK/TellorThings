...
const Trade = ({
  ...
  tradePairTokens, tagOptionsForDAI,
  ...
  >
    <div className="card trade">
      <h3>Automate Trade For (Swap Tokens For Exact ETH)</h3>
      ...
      <div className="form-field trade-footer">
        ...
        <Button
          ...
          bsStyle="primary"
          type="submit"
          onClick={(event) => swapTokensForExactETH(event)}
